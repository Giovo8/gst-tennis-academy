-- Migration 046: Add sets_won column to arena_stats and update trigger

-- Add column
ALTER TABLE public.arena_stats
  ADD COLUMN IF NOT EXISTS sets_won INTEGER DEFAULT 0;

-- Update trigger function to also track sets_won
...
BEGIN
  ...
  THEN
    ...
    SET
      ...
      wins               = wins + 1,
      sets_won           = sets_won + winner_sets_won,
    ...
    SET
      total_matches   = total_matches + 1,
      losses          = losses + 1,
      sets_won        = sets_won + loser_sets_won,
