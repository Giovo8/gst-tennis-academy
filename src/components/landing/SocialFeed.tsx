              ...
              <div className="grid grid-cols-3 gap-2">
                {Array.from({ length: 3 }).map((_, i) => (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="aspect-square rounded-lg bg-gradient-to-br from-white/10 to-white/5 hover:from-white/15 hover:to-white/10 transition flex items-center justify-center"
                  >
