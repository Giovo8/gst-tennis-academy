...
const variantConfig = {
  success: {
    bg: "bg-frozen-50 dark:bg-frozen-950 border-primary/30 dark:border-primary/80",
  ...
  info: {
    bg: "bg-frozen-50 dark:bg-frozen-950 border-frozen-200 dark:border-frozen-800",
