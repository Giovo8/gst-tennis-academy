      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isOpen && (
          <div className="lg:hidden border-t border-gray-100 mt-2 pt-4 space-y-3 pb-4 animate-in slide-in-from-top duration-300">
            {/* User Info */}
            {user && userRole && (
              <div className="text-center py-3 px-4 border-b border-gray-100 mx-2 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100">
            ...
            <div className="flex items-center justify-center gap-4 py-2 border-b border-gray-100">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors touch-manipulation"
                aria-label="Instagram"
              >
            ...
            <div className="space-y-2 px-2">
              <Link
                ...
                className="flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-sm min-h-[48px] touch-manipulation"
              >
              ...
              <a
                href="#contatti"
                onClick={() => setIsOpen(false)}
                className="block text-center py-3.5 text-sm font-medium text-gray-700 hover:text-gray-900 min-h-[48px] touch-manipulation"
              >
                Contatti
              </a>
              ...
              {user && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg min-h-[48px] touch-manipulation"
                >
