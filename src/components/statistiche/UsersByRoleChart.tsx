...
import { ROLE_COLORS, ROLE_LABELS } from "./chartColors";
...
/**
 * Donut utenti per ruolo, colori allineati ai badge ruolo di Admin > Utenti.
 */
export default function UsersByRoleChart({ usersByRole }: UsersByRoleChartProps) {
    ...
    <div className="w-full">
      <div className="w-full h-56 relative">
        ...
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-xs text-secondary/60">utenti totali</span>
        </div>
      </div>
