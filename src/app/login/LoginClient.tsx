      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-gray-200 p-6 sm:p-8 shadow-sm">
          ...
          <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Error Message */}
            {error && (
              <div className="rounded-lg sm:rounded-xl bg-frozen-100 border border-frozen-300 p-3 sm:p-4">
                <p className="text-xs sm:text-sm text-frozen-700 font-medium">{error}</p>
              </div>
            )}
            ...
            <button
              type="submit"
              className="w-full py-3 sm:py-4 px-4 bg-frozen-500 text-white font-bold rounded-lg sm:rounded-xl text-sm sm:text-base shadow-sm hover:bg-frozen-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
              {loading ? (
        ...
        <div className="mt-6 sm:mt-8 text-center">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-5 sm:py-3 bg-frozen-600 text-white rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold hover:bg-frozen-700 transition-all shadow-sm"
            >
        ...
        {/* Back to Home */}
        <div className="mt-6 sm:mt-8 text-center">
          <Link href="/" className="text-xs sm:text-sm text-gray-600 hover:text-frozen-600 transition-colors inline-flex items-center gap-2 font-medium">
