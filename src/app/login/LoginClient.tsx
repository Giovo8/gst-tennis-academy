    ...
    <main className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center gap-5 px-6 py-16">
      ...
      <div className="relative rounded-2xl border border-blue-400/20 bg-gradient-to-br from-blue-500/10 to-transparent backdrop-blur-xl p-6 shadow-2xl shadow-blue-500/10">
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-gradient-to-r from-emerald-500 via-blue-500 to-cyan-500 px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-500/30 transition-all hover:shadow-2xl hover:shadow-emerald-500/40 hover:-translate-y-1 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:scale-100"
            disabled={loading}
          >
            {loading ? (
      ...
      <div className="relative text-center space-y-3">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex items-center gap-2 rounded-xl border-2 border-green-400/40 bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm px-5 py-2.5 text-sm font-bold text-green-200 transition-all hover:from-green-500/30 hover:to-emerald-500/30 hover:border-green-400/60 hover:shadow-xl hover:shadow-green-500/30 hover:-translate-y-1 hover:scale-105"
          >
