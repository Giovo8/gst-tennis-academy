      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 sm:mb-10 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-secondary mb-3">Benvenuto</h2>
            <p className="text-base sm:text-lg text-secondary opacity-70">Accedi al tuo account</p>
          </div>
        ...
        <div className="mt-10 sm:mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-5 py-3 bg-secondary text-white rounded-md text-sm font-semibold hover:opacity-90 transition-all"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 bg-white border-2 border-secondary/20 text-secondary rounded-md text-sm font-semibold hover:border-secondary/40 transition-all"
            >
