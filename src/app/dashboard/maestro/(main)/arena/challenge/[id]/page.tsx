              ...
              <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm font-semibold text-green-800">Prenotazione registrata</h3>
                    <p className="mt-1 text-sm text-green-700">
                      Lo slot campo e stato registrato subito. Puoi fare riferimento ai dettagli qui sotto.
                    </p>
                  </div>
                </div>
              </div>
