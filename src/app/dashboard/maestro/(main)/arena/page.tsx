...
export default function ArenaPage() {
  ...
  useEffect(() => {
    ...
    if (success === 'challenge_created') {
      ...
      router.replace('/dashboard/maestro/arena');
    }
  }, [searchParams]);
  ...
  function handleBookMatch(challenge: Challenge) {
    ...
    router.push(`/dashboard/maestro/bookings/new?challenge_id=${challenge.id}`);
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button
            onClick={() => router.push("/dashboard/maestro/arena/choose-opponent")}
          ...
          <Link
            href="/dashboard/maestro/arena/storico"
          ...
          <Link
            href="/dashboard/maestro/arena/statistiche"
            className="p-2.5 text-secondary/70 bg-white border border-gray-200 rounded-md hover:bg-secondary hover:text-white transition-all"
            title="Statistiche"
          >
          ...
          <Link
            href="/dashboard/maestro/arena/info"
            className="p-2.5 text-secondary/70 bg-white border border-gray-200 rounded-md hover:bg-secondary hover:text-white transition-all"
            title="Info"
          >
            ...
            <div className="space-y-3 min-w-[750px]">
              ...
              {filteredChallenges.map((challenge) => {
                ...
                return (
                  <div
                    key={challenge.id}
                    onClick={() => router.push(`/dashboard/maestro/arena/challenge/${challenge.id}`)}
      ...
      <PlayerProfileModal
        ...
        onMessage={(playerId) => router.push(`/dashboard/maestro/mail?recipient=${playerId}`)}
      />
    </div>
  );
}
